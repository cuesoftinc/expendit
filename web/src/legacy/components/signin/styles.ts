...
const styles = {
  imgContainer:
    "w-[45%] bg-[#F3E8FF] md:flex hidden items-center justify-center ",
  ...
  buttonWrapper:
    "text-center rounded-md text-black my-5 py-3 shadow-lg font-semibold w-full",
  button:
  ...
  input: (cst?: boolean) =>
    `outline-none px-4 py-4 w-full ${
      cst && "shadow-sm border-black/80 border-[1px]"
    } bg-grayTheme rounded-lg focus:border-2 md:text-base text-sm`,
};
