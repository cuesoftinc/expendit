...
const Index = () => {
  const { form, formLoading, handleChange, handleSubmit, handleCancel } =
      ...
      <section>
        <div className={styles.introContainer}>
          ...
          <div className={styles.controlContainer}>
            ...
            <button className={styles.changeButton} onClick={handleSubmit}>
              {formLoading ? (
        ...
        <div className={styles.section}>
          <div className={styles.selfcenter}>
            ...
            <p className={styles.avatar}>
              This avatar would be displayed on your profile
            </p>
          </div>
          <div className={styles.imageContainer}>
            <Image className={styles.image} src={Avatar} alt="user-profile" />
          </div>
