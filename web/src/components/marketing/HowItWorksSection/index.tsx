...
function HowItWorks() {
  const grids = [
    ...
    },
    {
      ...
      sub_title:
        "With the credentials used in creating an account, log into your account",
      imgSrc: Log,
    },
    {
      title: "Input your budget",
      sub_title:
        "Input the amount of money you intend to spend in a specific period of time",
      imgSrc: Dollar,
    },
    {
    ...
    },
    {
      ...
      sub_title:
        "Input an expense that includes date, amount and a category you created earlier",
      imgSrc: DollarBook,
    },
    {
      title: "View Real-Time Reports",
      sub_title:
        "View real-time reports about your expenses based on the data you provided",
      imgSrc: RealTime,
    },
  ];
